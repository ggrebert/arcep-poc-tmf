...
@Path("/api/anomalieAdresse")
@Tag(ref = "Anomalie Adresse Proxy")
public class AnomalieAdresseResource {

  private static final String CLIENT_ID = "anomalieAdresse";
  ...
  @Operation(
      summary = "List all allowed trouble tickets of type 'anomalieAdresse'.",
  ...
  @APIResponse(
      ...
      content =
          @Content(
              ...
              schema = @Schema(type = SchemaType.ARRAY, implementation = AnomalieAdresse.class)),
      description =
          """
  ...
  @APIResponse(
      ...
      content =
          @Content(
              ...
              schema = @Schema(implementation = AnomalieAdresse.class)))
  ...
  @HEAD
  @Operation(
      summary = "Count the number of trouble tickets of type 'anomalieAdresse'.",
  ...
  @POST
  @Operation(
      summary = "Create a new trouble ticket of type 'anomalieAdresse'.",
  ...
  @APIResponse(ref = "error-502")
  @APIResponse(ref = "error-503")
  public Uni<Response> create(@Valid AnomalieAdresse malfacon) {
    return troubleTicketService
  ...
  @Path("/{id}")
  @Operation(
      summary = "Get a trouble ticket of type `anomalieAdresse`.",
  ...
  @Path("/{id}")
  @Operation(
      summary = "Delete a trouble ticket of type 'anomalieAdresse'.",
